...
This file is the live execution board. Keep completed items visible for a while instead of deleting them immediately.
...
- [ ] Review baseline constraint documents with the project owner.

## Blocked

- [ ] Campus official APP scan login integration details are not available yet.

## Done

- [x] Connect repository to `https://github.com/haiziyao/XJTUhub.git`.
- [x] Choose Phase 1 priority: community discussion > resource sharing > information aggregation.
